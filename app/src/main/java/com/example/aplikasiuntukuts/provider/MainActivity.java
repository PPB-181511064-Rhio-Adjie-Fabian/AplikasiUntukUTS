...
import com.example.aplikasiuntukuts.data.ViewModelV2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ViewModelV2 cheeseViewModel;
...
//        LoaderManager.getInstance(this).initLoader(LOADER_CHEESES, null, mLoaderCallbacks);
        ...
        cheeseViewModel = new ViewModelProvider(this).get(ViewModelV2.class);
...
//    private final LoaderManager.LoaderCallbacks<List<Cheese>> mLoaderCallbacks =
//            new LoaderManager.LoaderCallbacks<List<Cheese>>() {
//
//                @Override
//                @NonNull
//                public Loader<List<Cheese>> onCreateLoader(int id, @Nullable Bundle args) {
...
//
//                @Override
//                public void onLoadFinished(@NonNull Loader<Cursor> loader, List<Cheese> data) {
...
//            };
    ...
    private static class CheeseAdapter extends RecyclerView.Adapter<CheeseAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            if(list != null){
                Cheese currentData = list.get(position);
                holder.mText.setText(currentData.getName());
            } else{
                holder.mText.setText("No Data");
            }
        }
        ...
        void setCheeses(List<Cheese> list) {
            this.list = list;
